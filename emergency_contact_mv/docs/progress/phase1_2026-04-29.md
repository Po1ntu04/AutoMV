...
- Validation: `{"configs_present": true, "env_example_present": true, "song_present": true, "lyrics_present": true, "ffmpeg_present": true, "ffprobe_present": true, "live_api_default": false, "api_env_present": {"OPENAI_API_KEY": false, "DASHSCOPE_API_KEY": false, "ALIYUN_OSS_ACCESS_KEY_ID": false, "ALIYUN_OSS_BUCKET_NAME": false}, "ok": true}`
